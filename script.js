...
class PortfolioApp {
    ...
    checkMaintenanceMode() {
        ...
        const maintenanceImage = document.getElementById('maintenance-image');
        
        if (this.settings.maintenance && this.settings.maintenance.enabled) {
            maintenanceOverlay.style.display = 'flex';
            if (this.settings.maintenance.image) {
                maintenanceImage.src = this.settings.maintenance.image;
            }
        } else {
    ...
    renderBadges() {
        ...
        badges.forEach(badge => {
            ...
            let badgeContent = '';
            if (badge.type === 'image') {
                badgeContent = `<img src="${badge.icon}" alt="${badge.tooltip}" class="badge-image">`;
            } else {
                badgeContent = `<span class="badge-icon">${badge.icon}</span>`;
            }
...
// Reviews are now CSS-animated, no JS needed for scrolling
