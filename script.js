class PortfolioApp {
    ...
    setupScreenNavigation() {
        ...
        const btnContactHome = document.getElementById('btn-contact-home');
        if (btnContactHome) {
            btnContactHome.addEventListener('click', () => {
        ...
        /* Hamster Interaction */
        const hamster = document.getElementById('hamster-decoration');
        const flower = document.getElementById('hamster-flower');

        if (hamster && flower) {
            hamster.addEventListener('click', () => {
                // The flower's position is now handled by CSS and the style attribute in HTML.
        ...
        if (contactMeBtn) {
            contactMeBtn.addEventListener('click', () => {
                ...
                if (discordModal) {
                    discordModal.style.display = 'block';
                    document.body.style.overflow = 'hidden';
                    const decorations = document.querySelector('.top-flags-container');
                    if (decorations) decorations.classList.add('vis-hidden');
                }
            });
        }
    }
    ...
    loadProjects() {
        if (window.projectsData) {
            ...
            console.error('Projects data not found. Make sure projects.js is loaded.');
            this.projects = [];
        }
    }
    ...
    setupEventListeners() {
        ...
        const contactMeBtn = document.getElementById('btn-contact-home');
        const btnCheckPastWork = document.getElementById('btn-straight-to-hiring');
        const backFromStyles = document.getElementById('back-from-style-selection');
        const backFromStore = document.getElementById('back-from-store');
        ...
        if (discordClose) {
            discordClose.addEventListener('click', () => {
                ...
                document.body.style.overflow = 'auto';
                const decorations = document.querySelector('.top-flags-container');
                if (decorations) decorations.classList.remove('vis-hidden');
            });
        }
